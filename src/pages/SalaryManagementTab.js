      ...
      <div className="container">
        ...
        <div className="content-tabs">
          ...
          >
            ...
            <form>
              <h4 className="title">Branch No : </h4>
              <FormRow
                type="name"
                name="name"
                // value={values.name}
                ...
                className="input"
              />
              <h4 className="title">Owner NIC : </h4>
              <FormRow
                type="name"
                name="link"
                // value={values.link}
              ...
              <FormRow
                ...
                className="input"
              />
              <h4 className="title">Return BD : </h4>
              <FormRow
                type="name"
                name="password"
                // value={values.password}
                ...
                className="input"
              />
              <h4 className="title">Damage BD : </h4>
              <FormRow
                type="name"
                name="password"
                // value={values.password}
          ...
          >
            <h3>Transport</h3>
            <form>
              <h4 className="title">Sales Count : </h4>
              <FormRow
                type="name"
                name="name"
                // value={values.name}
                ...
                className="input"
              />
              <h4 className="title">New Sales Count : </h4>
              <FormRow
                type="name"
                name="link"
                // value={values.link}
